...
class PDF(FPDF):
    ...
    def header(self):
        ...
        self.image('assets/dominio1.png', 15,6,18 )
    ...
    def footer(self):
        ...
        # 
        footer_text = f'Pflex1_R0 (APP by Enginapps.it) - Page {self.page_no()}/{{nb}}'
        footer_w = self.get_string_width(footer_text)
        doc_w = self.w 
        #self.set_xy(doc_w/2,-15)
        #self.set_xy((doc_w - footer_w)/2,-15)
        self.set_xy((doc_w - footer_w)/2,-25)
        self.set_font('helvetica', 'I', 10)
        # page number
        self.cell(10, 10, f'Pflex1_R0 (APP by Enginapps.it) - Page {self.page_no()}/{{nb}}')  
